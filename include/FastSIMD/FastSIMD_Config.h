...
#define FASTSIMD_AVX_SUPPORTED false
#else
#define FASTSIMD_AVX_SUPPORTED true
#endif
...
#define FASTSIMD_COMPILE_AVX    (FASTSIMD_x86 & FASTSIMD_AVX_SUPPORTED & false) // Not supported
#define FASTSIMD_COMPILE_AVX2   (FASTSIMD_x86 & FASTSIMD_AVX_SUPPORTED & true )
#define FASTSIMD_COMPILE_AVX512 (FASTSIMD_x86 & FASTSIMD_AVX_SUPPORTED & true )
